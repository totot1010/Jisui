      ...
      <div className="flex">
        <div className="w-16 flex flex-col items-center space-y-4 fixed left-4 top-1/2 transform -translate-y-1/2 z-10">
          <div className="relative group">
            <Link href="/upload" className="bg-primary-500 text-black p-3 rounded-full hover:bg-primary-600 transition-colors duration-200 shadow-lg flex items-center justify-center w-12 h-12">
              <PenSquare size={24} />
            </Link>
